...
import url, { getInvoiceById } from "../../invoice/InvoiceService";
...
const dummydata=[{
  file:'',
  description:"Adco Hand Wash 500ml",
  unit_of_measure:"mm",
  sell_price:7.00,
  quantity:9,
  total_amount:63.00
...
const InvoiceViewer = ({ toggleInvoiceEditor,list = [],
  ...
  const invoicegenrate= (sidebarSettings) => {
       ...
       history.push(`/print_Joborder/${id}`)
...
// pri.print();
  ...
  const statuschange = (status) => {
    ...
    //   })
          if(status==="accept")
          history.push('/print_quote_tab/2') 
    //   }
    // })
  ...
  return (
    ...
    <RadioGroup aria-label="quiz" name="quiz" value={value} onChange={handleRadioChange}>
      <FormControlLabel value="Add to Job List" control={<Radio />} label="Add to Job List" />
      <FormControlLabel value="Do Outsource" control={<Radio />} label="Do Outsource" />
    </RadioGroup>
    </FormControl>
  ...
  <div style={{marginLeft:'50px'}}>
    ...
    شركة أماكو العربية للمقاولات</h2>
      ...
      <h3 style={{color:'#1d2257',textAlign:'right',fontSize:20}}>
        AMACO MANUFATURING & INDUSTRIAL SERVICES PVT. LTD.
...
{/* 
          ...
          <TableHead style={{backgroundColor:'#1d2257',display:'table-row-group'}}>
            <TableRow  style={{pageBreakInside:'avoid'}}> 
              ...
              <TableCell className="px-0" colspan={2} style={{border: "1px solid #ccc",fontFamily: "Calibri",color:'#fff',fontColor:'#fff',fontWeight:1000,fontSize: 16}}  align="center">ITEM</TableCell>
                <TableCell className="px-0" colspan={5} style={{border: "1px solid #ccc",fontFamily: "Calibri",color:'#fff',fontColor:'#fff',fontWeight:1000,fontSize: 16}}  align="center">DESCRIPTION</TableCell>
                    ...
                    <div className="px-4 flex justify-between">
                      <div className="flex">
                        <div className="pr-12" style={{wordBreak:'break-word',fontSize: 16}}>
                          ...
                          <strong>TOTAL IN WORDS</strong><br></br>Seventy Two Riyals And Forty Five Halala Only
                          {/* {ress} */}
                        </div>
                      </div>
                    </div>
      ...
      <br></br>
       ...
       <div  class="right" style={{width: '60px',height: '5ex',backgroundColor: '#fff',shapeOutside: 'polygon(100% 0, 100% 100%, 0 100%)',float: 'right',webkitClipPath: 'polygon(100% 0, 100% 100%, 0 100%)'}}></div>           
        ...
        <div style={{"position": "fixed", bottom: 0, width: "100%", height: 30, backgroundColor:"#1d2257",}}> <p   style={{textAlign: 'center',color:'white',fontFamily: "Calibri",paddingTop:5,paddingBottom:10,"transform": "skew(20deg)"}}>E-mail: print@amaco.com.sa | Website: www.amaco.com.sa</p></div>
    </div> 
           </div>
