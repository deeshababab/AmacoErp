...
import url,{getVendorList,capitalize_arr, getInvoiceById, addInvoice, updateInvoice,getCustomerList} from "../../invoice/InvoiceService";
          ...
          <h5 className="font-normal capitalize">
            ...
            <TextField
                ...
                {/* </Button> */}
                    ...
                    <MenuItem value="1">Systimax</MenuItem>
                    <MenuItem value="2">Honey Well</MenuItem>
                  </TextField>
                ...
                {rfqstatus &&
                  ...
                  >
                    ...
                    <MenuItem value="1">Jhon</MenuItem>
                    <MenuItem value="2">Burky</MenuItem>
                  </TextField>
                  }
                  </div>
        ...
        <Divider />
          ...
          <TableHead>
            <TableRow className="bg-default">
              ...
              <TableCell className="px-0" style={{width:'150px'}}>Matrial Name</TableCell>
              <TableCell className="px-0" style={{width:'200px'}}>Description</TableCell>
              <TableCell className="px-0" style={{width:'100px'}}>UOM</TableCell>
              <TableCell className="px-0" style={{width:'100px'}}>Width</TableCell>
              <TableCell className="px-0" style={{width:'100px'}}>Height</TableCell>
              <TableCell className="px-0" style={{width:'100px'}}>Quantity</TableCell>
...
:(<span><Icon color="error" onClick={(event) => deleteFileSelect(event,index)}>close</Icon><img className="w-48" src={item.src} alt="" ></img></span>)}
                  ...
                  <TableCell className="pl-0 capitalize" align="left" style={{width:'200px'}}>
                    ...
                    >
                      <MenuItem value="false">
                        ...
                        <MenuItem value="1">PP-SG</MenuItem>
                        <MenuItem value="2">PP-Matt</MenuItem>
                    </TextValidator>
                  </TableCell>
                  ...
                  <TableCell className="pl-0 capitalize"  align="left" style={{width:'100px'}}>
                    <TextValidator
                      label="Qty"
                      onChange={(event) => dummycal(event, index)}
                      type="text"
                      variant="outlined"
                      size="small"
                      fullWidth
